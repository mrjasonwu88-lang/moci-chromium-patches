...
| `moci-fp08-tls-grease.patch` | 43 | fp-08 BoringSSL `SSL_HANDSHAKE::grease_seed[8]` 用 FNV-1a 派生（同时覆盖 TLS 1.2/1.3 + HTTP/3-over-QUIC 的 ClientHello）— JA3/JA4 hash 单 env 稳定、跨 env 全异 |
